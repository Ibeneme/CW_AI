...
const GameBoard: React.FC = () => {
  ...
  const handleClick = (index: number) => {
    ...
    if (
      (currentPlayer === "You" && index >= 6) ||
      (currentPlayer === "Opponent" && index < 6)
    ) {
      setError(
        `Cannot play from ${
          currentPlayer === "You" ? "Opponent's" : "Your"
        } holes!`
      );
    ...
    const dropSeed = (remainingSeeds: number) => {
      ...
      currentIndex =
        moveOrder[(moveOrder.indexOf(currentIndex) + 1) % moveOrder.length];
    ...
    <div className="game-board-container">
      ...
      <div className="game-media-new">
        <div className="score-board">
          ...
          >
            <div style={{ color: "#222" }}>Opponent: </div>
            <div
              style={{
                backgroundColor: "#222",
                padding: 16,
          ...
          <div className="game-media">
            ...
            <div className="game-row">
              {holes.slice(6, 12).map((seeds, index) => (
                <button
                  key={index + 6}
                  className={`system-hole ${
                    activeHole === index + 6 ? "active-hole" : ""
                  }`}
